...
#ifndef __CVC4__THEORY__BV_INPUT__THEORY_BV_INPUT_REWRITER_H
#define __CVC4__THEORY__BV_INPUT__THEORY_BV_INPUT_REWRITER_H
...
class TheoryBvInputRewriter {
public:

  /**
   * Rewrite a node into the normal form for the theory of bv_input.
...
#endif /* __CVC4__THEORY__BV_INPUT__THEORY_BV_INPUT_REWRITER_H */
